...
final class AppSettings: ObservableObject {
    ...
    private let backupManager = AppSettingsBackupManager()
    ...
    private init() {
        backupManager.restoreSettingsFromBackupIfNeeded()
        ...
        backupManager.persistForUpdateSafety()
        backupManager.observeDefaultsChangesForUpdateSafety()
    }
